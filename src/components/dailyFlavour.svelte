...
<div class="container">
	<div class="one">
		<H4 heading={'Special Dishes'} />
		<InnerH1 heading={'Daily Flavor Explosion'} />
	</div>
	<div class="two">
		Our Daily Flavor Explosion is a section dedicated to showcasing the vibrant and diverse flavors
